...
function ST7789() {
    ...
    //var spi = new SPI();
    SPI1.setup({sck:D30, mosi:D29, baud: 8000000});
    return connect({spi:SPI1, dc:D31, cs:D11, rst:D12});
}
D5.set();
...
g.clear();
  g.setFontVector(20).setFontAlign(0,-1);
    g.setColor("#FFFFc0").setFontVector(20);
    g.drawString("Espruino",62,20);
    g.setColor("#80c0c0").setFontVector(16);
    g.drawString("ID130Plus",62,80);
    g.setColor("#FFFFFF").setFontVector(24);
    g.drawString("ST7789",62,200);
    g.drawString("135 x 241",62,220);
